        ...
        <main>
            ...
            <div id="tab-chat" class="content-panel active">
                ...
                <div class="input-group">
                    <input type="text" id="userInput" placeholder="Nhập tin nhắn hoặc tiếng H'Mông..." />
            ...
            <div id="tab-image" class="content-panel">
                <div class="tool-card">
                    ...
                    <textarea id="imagePrompt" rows="3" placeholder="Ví dụ: Chân dung cô gái người H'Mông..."></textarea>
                    <br><br>
                ...
                <div id="imageResult" class="tool-card" style="display:none; text-align:center;">
                    ...
                    <p id="imgStatus" style="color: #64748b;">Đang khởi tạo...</p>
                </div>
            </div>

            <div id="tab-video" class="content-panel">
                <div class="tool-card">
                    <h3>🎬 Trình Tạo Video AI <span class="badge">Hot</span></h3>
            ...
            <div id="tab-vision" class="content-panel">
                <div class="tool-card">
                    ...
                    <br><br>
                    <textarea id="visionQuestion" rows="2" placeholder="Câu hỏi về ảnh..."></textarea>
                    <br><br>
            ...
            <div id="tab-files" class="content-panel">
                <div class="tool-card">
                    ...
                    <button class="send-btn" onclick="uploadFileAI()">Tải lên & Tóm tắt</button>
                </div>
            ...
            <div id="tab-admin" class="content-panel">
                <div class="tool-card">
                    ...
                    <p>Trạng thái: <span class="badge" style="background:#dcfce7; color:#166534;">🟢 Online</span></p>
                </div>
            </div>
        </main>
        ...
        <script>
            ...
            async function handleSendMessage() {
                ...
                try {
                    ...
                    chatBox.innerHTML += '<div class="message ai">' + (data.reply || 'Không có phản hồi') + '</div>';
                } catch (error) {
                    const loadingEl = document.getElementById(loadingId);
                    if (loadingEl) loadingEl.remove();
            ...
            // Gán sự kiện trực tiếp bằng JS thuần để ăn ngay trên điện thoại
            ...
            function generateImageAI() {
                ...
                document.getElementById('imgStatus').innerText = 'Đang tiến hành tạo ảnh: "' + prompt + '"...';
            }
            ...
            function generateVideoAI() {
                ...
                document.getElementById('vidStatus').innerText = 'Đang render video...';
            }
            ...
            async function analyzeVision() {
                ...
                outBox.innerText = 'Đang phân tích...';
                try {
                    ...
                    outBox.innerText = 'Lỗi phân tích!';
                }
            }
            ...
            function uploadFileAI() {
                ...
                fRes.innerHTML = '<h4>Trạng thái:</h4><p>Đã tải lên thành công!</p>';
            }
        </script>
    </body>
    </html>
